  ...
  return (
    <main className="relative min-h-screen">
      <section id="home" className="grid min-h-screen grid-cols-2">
        ...
        <div className="relative isolate flex flex-col overflow-hidden justify-center bg-[#587fba] px-14 text-white">
          ...
          <div className="relative z-10 mx-auto w-full max-w-[560px]">
            ...
            <h1 className="mt-2 text-5xl font-extrabold uppercase md:text-6xl">
              Hi! I&apos;m{" "}
              <span className="text-[#c3cae5]">Yoga</span>
              <br />
              Setia Triputra
            </h1>
            ...
            <div className="mt-7 gap-5 flex flex-wrap">
              <a
                href="#project"
                className="border-2 border-white bg-[#f0eee9] px-3 py-2 font-bold text-black shadow-[4px_5px_0_#111827] transition hover:translate-x-1 hover:translate-y-1 hover:shadow-none hover:bg-blue-400 hover:text-white"
              >
                Viem my Works ↗
              </a>
              <a
        ...
        {/* RIGHT SIDE (Updated with spacious margins & proper padding) */}
        <div className="flex min-h-screen items-center px-10 pt-32 pb-16 md:px-16">
          <div className="w-full max-w-2xl">
            ...
            {/* Heading */}
            <h2 className="mt-4 text-xl font-extrabold leading-tight text-slate-900 md:text-5xl">
              I turn ideas into{" "}
            ...
            {/* Paragraph */}
            <p className="mt-5 max-w-lg text-lg leading-6 text-slate-700">
              Passionate about solving problems through code and creating
              impactful digital experiences.
            </p>

            {/* 3 Feature Cards (Spacious padding & gaps) */}
            <div className="mt-10 grid gap-5 md:grid-cols-3">
              {/* Card 1: Clean Code */}
              <div className="rounded-xl border border-slate-900 bg-[#e5ebf5]/90 p-5 shadow-[4px_4px_0_#1e293b] hover:-translate-y-0.5 transition-transform">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              {/* React */}
              <div className="flex items-center gap-2 rounded-lg border border-slate-400 bg-white/90 px-3.5 py-2 text-xs font-bold text-slate-800 shadow-sm">
              ...
              {/* JavaScript */}
              <div className="flex items-center gap-2 rounded-lg border border-slate-400 bg-white/90 px-3.5 py-1.5 text-xs font-bold text-slate-800 shadow-sm">
            ...
            {/* Quote Block */}
            <div className="mt-12 flex gap-4 text-slate-700">
